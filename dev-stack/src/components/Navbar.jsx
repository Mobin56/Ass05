    ...
    <nav className="sticky top-0 z-50 border-b border-gray-100 bg-white/95 backdrop-blur">
      <div className="mx-auto flex max-w-7xl items-center justify-between px-5 py-3.5">
        ...
        <div className="hidden items-center gap-2 md:flex">
          <button className="rounded-full px-4 py-2 text-xs font-medium text-gray-600 transition hover:bg-gray-50 hover:text-gray-900">
            Sign In
          </button>

          <button className="rounded-full bg-gradient-to-r from-orange-500 via-pink-500 to-violet-600 px-5 py-2.5 text-xs font-semibold text-white transition hover:opacity-90">
            Sign Up
          </button>
        </div>
        ...
        <div className="border-t border-gray-100 bg-white px-5 py-5 md:hidden">
          <div className="flex flex-col gap-4">
            ...
            <div className="flex gap-3 border-t border-gray-100 pt-4">
              <button className="flex-1 rounded-full border border-gray-200 py-2.5 text-sm font-semibold text-gray-700 transition hover:bg-gray-50">
                Sign In
              </button>

              <button className="flex-1 rounded-full bg-gradient-to-r from-orange-500 via-pink-500 to-violet-600 py-2.5 text-sm font-semibold text-white transition hover:opacity-90">
                Sign Up
              </button>
            </div>
